...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Call the updateProduct() function to update the product in the database
    $result = updateProduct($idProduct, $reference, $description, $priceTaxIncl, $priceTaxExcl, $idLang, $quantity);

    if ($result) {
        // Product updated successfully, redirect to the display page or show a success message      header('Location: index.php?action=display');
        exit();
    } else {
